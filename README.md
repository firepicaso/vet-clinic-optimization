...
**Vet Clinic** is a project that is focused on creating a database for a vet clinic and be able to filter the data based on different criteria.
...
```sh
cd my-folder
git clone https://github.com/firepicaso/vet-clinic.git
```
...
- [ ] **vet-clinic website**
- [ ] **more robust database with many more categories of animals**
